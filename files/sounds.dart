...
class SoundEngine {
  ...
  // ── Public API ──────────────────────────────────────────────────────────────
  static void playAdd()    => _play(_sfx,   _buildAdd());
  static void playRemove() => _play(_sfx,   _buildRemove());
  static void playTab()    => _play(_sfx,   _buildTab());
  static void playAlarm()  => _play(_alarm, _buildAlarm());

  static void _play(AudioPlayer p, Uint8List bytes) {
    try { p.play(BytesSource(bytes)); } catch (_) {}
  }
