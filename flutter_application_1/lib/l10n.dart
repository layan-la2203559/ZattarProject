...
class S {
  ...
  // Settlement dialog
  String get settleDialogTitle   => ar ? 'تسوية الدين'           : 'SETTLE DEBT';
  String get settleOwedMeDesc    => ar ? 'هذا المال مستحق لك'    : 'THIS MONEY IS OWED TO YOU';
  String get settleIOweDesc      => ar ? 'هذا المال مستحق منك'   : 'YOU OWE THIS MONEY';
  String get settleAddBalance    => ar ? '+ أضف للرصيد'          : '+ ADD TO BALANCE';
  String get settleDeductBalance => ar ? '- اخصم من الرصيد'      : '- DEDUCT FROM BALANCE';
  String get settleNoBalance     => ar ? '○ تسوية بدون تغيير الرصيد' : '○ SETTLE WITHOUT BALANCE CHANGE';
  String get cancelBtn           => ar ? 'إلغاء'                 : '[ CANCEL ]';
  String get settledCredited     => ar ? '>> تمت التسوية، أضيف'  : '>> SETTLED — CREDITED';
  String get settledDebited      => ar ? '>> تمت التسوية، خصم'   : '>> SETTLED — DEBITED';
  String get settleHint          => ar ? '► اضغط تسوية لاختيار كيفية التسوية' : '► TAP SETTLE TO CHOOSE HOW TO CLOSE THE DEBT';
